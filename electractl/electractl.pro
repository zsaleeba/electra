...
INCLUDEPATH += $$PWD/../protocol $$OUT_PWD/../protocol
DEPENDPATH += $$PWD/../protocol $$OUT_PWD/../protocol
...
unix|win32: LIBS += -ljsoncpp -lmicrohttpd -ljsonrpccpp-common -ljsonrpccpp-client
